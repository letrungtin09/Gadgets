  ...
  for (let i = 0; i < data.length; i++) {
    ...
    dataList = `
        <div class="all-item" id="${i + 1}">
            <a class="bestseller__card" href="detailProduct.html">
                <div class="card">
    ...
    let baseUrl = "http://127.0.0.1:5500/detailProduct.html";
    let link = document.querySelectorAll(".bestseller__card");
    link.forEach((element, index) => {
      element.href = `${baseUrl}?${data[i].idProduct}`;
    });
  }
}
fetchDataAll();
